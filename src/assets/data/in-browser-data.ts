...
export class IdeaQuotes {
  static ideaQuotesData: Array<any> = [
    {
    ...
    {
      viewAuthor: 'Carl Sagan',
      viewImage: 'https://pbs.twimg.com/media/ExLDl5MVkAUTMGz?format=jpg&name=small',
      viewPrimaryContent: `"One glance at a book and you hear the voice of another person, perhaps someone dead for 1,000 years. To read is to voyage through time." `,
      viewSecondaryContent: 'Carl Sagan was a scientist and educator best known for his TV series Cosmos, the Pale Blue Dot image of Earth and quotes about life.',
      visible: false
    },
    {
